...
val defaultPlaceIdsList: List<Long> = listOf(64495L, 2L, 3L, 4L, 5L)
...
val defaultPlaceResponse = listOf(
    PlaceResponse(LatLng(11.1,123.4), "자하연",1, "연못"),
    PlaceResponse(LatLng(121.1,103.4), "중도",3, "공부장소")
)
